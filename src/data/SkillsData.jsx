const SkillsData = [
    {
        ...
        skills: [
            ...
            { name: 'JSON', image: 'https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/json.svg' }
        ]
    },
    {
        title: 'Frontend',
    ...
    },
    {
        ...
        skills: [
            ...
            { name: 'Bitbucket', image: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bitbucket/bitbucket-original-wordmark.svg' },
